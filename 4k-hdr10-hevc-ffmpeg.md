Encodear con FFmpeg: 4K HDR10 HEVC
==================================
...
La opción CRF tiene un rango entre 18 a 23 (menor número más preserva calidad). Recomiendo usar 18 para una calidad visual sin pérdidas. 
